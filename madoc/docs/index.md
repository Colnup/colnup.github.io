...
# A blatent copy of the Svelte doc
...
Please see the [Contributing Guide](CONTRIBUTING.md) and the [`svelte`](https://github.com/sveltejs/svelte/tree/main/packages/svelte) package for information on contributing to Svelte.
